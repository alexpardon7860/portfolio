...
// Import certificate images from data directory
import certificate1 from '../data/certificate_1.jpg';
import certificate2 from '../data/certificate_2.jpg';
import certificate3 from '../data/certificate_3.jpg';
...
export default function DomeGallery({
  ...
  useEffect(() => {
    ...
    const loop = (time) => {
      ...
      if (lastAutoRotateTime.current === 0) lastAutoRotateTime.current = time;
      const dt = time - lastAutoRotateTime.current;
      lastAutoRotateTime.current = time;

      // Only auto-rotate if not dragging, not opening, and no inertia active
      if (!draggingRef.current && !openingRef.current && !inertiaRAF.current && !focusedElRef.current) {
        // defined speed: degrees per second (e.g., 5 deg/sec)
        const speed = 1.5;
